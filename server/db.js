...
const db = {
  ...
  products: [
    ...
    },
    {
      ...
      originalPrice: 4399,
      condition: 8,
      images: ['/pictures/iPad Air 4 64G.png'],
      sellerId: 2,
      sellerNickname: '张三',
      sellerSchool: 'XX大学',
      status: 'active',
    ...
    },
    {
      ...
      originalPrice: 89,
      condition: 8,
      images: ['/pictures/Python编程从入门到实践.png'],
      sellerId: 3,
      sellerNickname: '李四',
      sellerSchool: 'XX大学',
      status: 'active',
    ...
    },
    {
      ...
      originalPrice: 350,
      condition: 8,
      images: ['/pictures/机械键盘 Keychron K2.png'],
      sellerId: 2,
      sellerNickname: '张三',
      sellerSchool: 'XX大学',
      status: 'active',
