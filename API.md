...
## 评价（模块4）
### POST /api/reviews
- 请求体: `{ orderId, rating: 1-5, content? }`
- 限制: 仅买卖双方可评价，7天窗口，卖家只能评星
- 响应: `{ review: {...} }`
...
- 响应: `{ message: "封禁成功", userId, nickname }`

### PUT /api/admin/users/:id/unban
- 响应: `{ message: "解封成功", userId, nickname }`
